...
import com.company.jhipsterapp.domain.Employee;
import com.company.jhipsterapp.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).department(UPDATED_DEPARTMENT);
